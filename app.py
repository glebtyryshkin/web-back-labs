...
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'a4f9c2e1b8d34c1a9f0e7d6c5b4a3f2e1d0c9b8a7f6e5d4c3b2a1f0e9d8c7b6')
app.config['DB_TYPE' ] = os.getenv('DB_TYPE', 'postgres' )

if app.config['DB_TYPE'] == 'postgres':
    db_name = 'gleb_tyryshkin_orm'
    db_user = 'gleb_tyryshkin_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = os.path.join(dir_path, 'gleb_tyryshkin_orm.db')
